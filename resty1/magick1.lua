...
try_to_load = function(name)
  ...
  return error("Failed to load ImageMagick (" .. tostring(name) .. ")")
end
local lib = try_to_load("/usr/lib/x86_64-linux-gnu/libMagickWand.so.5")
local can_resize
if get_filters() then
